...
Список фичей, которые хотелось бы добавить, но не хватило времени:

#### **1. Обновление данных избранных токенов IRL**

#### **2. Форма создания токена**

#### **3. Signin, Signup**

#### **4. Хранение и получение данных о токене с последюущим построение графиков изменения цены, объёма**

#### **5. Добавление токена в избранное**
